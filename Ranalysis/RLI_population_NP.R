#-------------------------------------------------------- ##NP: copy-paste exame same header from Calculate_yearly_RL_status_for_populations.R
#--------------------------------------------------------
...
RLI_population<-function(dat){  # dat<- the data.frame with the yearly Red List status from 1950-2019 of all populations
  ...
  rli_data$max_threat_score<-number_stocks*5 # number_stocks * 5 which is the maximum threat equivalent to the Red List Category Extinct.
